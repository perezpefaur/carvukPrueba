...
const timeline = [
  ...
  {
    id: 2,
    content: 'Carvuk lo recoge donde',
    target: 'más te acomode',
    href: '#',
    date: '⏱',
    datetime: '2020-09-22',
    icon: CheckIcon,
  ...
  {
    id: 3,
    content: 'Lo llevamos a la',
    target: 'revisión técnica (costo incluído)',
    href: '#',
    date: '🚗',
    datetime: '2020-09-28',
    icon: CheckIcon,
  ...
  {
    id: 4,
    content: 'Si sale rechazado, te ayudamos a',
    target: 'resolverlo',
    href: '#',
    date: '👨🏻‍🔧',
    datetime: '2020-09-28',
